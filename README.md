...
## Решения
  * <a href="https://github.com/Nephedov/9.Java/blob/df78871be6bbd22afdcc82c8fb5a23365a7af593/src/main/java/ru/netology/json/Post.java">Post.java</a>.
  * <a href="https://github.com/Nephedov/9.Java/blob/df78871be6bbd22afdcc82c8fb5a23365a7af593/src/main/java/ru/netology/json/FormDate.java">FormDate.java</a>.
  * <a href="https://github.com/Nephedov/9.Java/blob/df78871be6bbd22afdcc82c8fb5a23365a7af593/src/main/java/Main.java">Main.java</a>.

## Что было сделано
  * Разработаны классы, описывающие объекты запроса анкеты на сервер, и продемонстрирована их работа в Main.
  * Создан класс Post, описывающий объект запроса на сервер.
  * Создан класс FormDate описывающий схему объекта в поле birthday.
